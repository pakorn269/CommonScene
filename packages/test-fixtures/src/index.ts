...
import type { Room, Participant, PreferenceProfile } from '@commonscene/contracts';
...
export const SAMPLE_PROFILES: PreferenceProfile[] = [PROFILE_ALICE, PROFILE_BOB, PROFILE_CHARLIE];
...
export const SAMPLE_ROOM_COLLECTING: Room = {
  ...
  participantIds: [PARTICIPANT_ALICE_ID, PARTICIPANT_BOB_ID, PARTICIPANT_CHARLIE_ID],
};
