...
export function isRatingAllowed(
  ...
  const movieLevel = CONTENT_RATING_HIERARCHY[movieRating as ContentRating] ?? 99;
...
export type StructuredCandidatePreferences = z.infer<typeof StructuredCandidatePreferencesSchema>;
...
export type ScoredComponentBreakdown = z.infer<typeof ScoredComponentBreakdownSchema>;
...
export type SubmitPreferencesRequest = z.infer<typeof SubmitPreferencesRequestSchema>;
...
export type ParticipantUpdatedEvent = z.infer<typeof ParticipantUpdatedEventSchema>;
...
export type PreferencesSubmittedEvent = z.infer<typeof PreferencesSubmittedEventSchema>;
...
export type RecommendationsReadyEvent = z.infer<typeof RecommendationsReadyEventSchema>;
