...
- [x] `README.md` includes complete setup instructions for Windows/WSL 2 and Vega OS
...
- [x] Mobile PWA source is in `apps/mobile` (React + Vite PWA)
...
- [x] Formula: $Score(m) = 0.45 \cdot Avg(m) + 0.35 \cdot Min(m) + 0.20 \cdot Coverage(m) - Penalty(m)$
...
- [x] Friction Log with 5 documented technical entries in `docs/friction-log.md`
- [x] Structured Product Feedback for Amazon tooling in `docs/product-feedback.md`
