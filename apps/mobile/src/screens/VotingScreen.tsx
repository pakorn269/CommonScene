        ...
        <div>
            ...
            {recommendations.map((rec, index) => {
                ...
                return (
                    <div
                        key={movie.id}
                        className={`candidate-card ${isVoted ? 'voted' : ''}`}
                    >
                        ...
                        <div style={{ display: 'flex', gap: 8, fontSize: '0.8rem', color: '#94A3B8', marginBottom: 10 }}>
                            <span>{movie.runtimeMinutes} min</span>
                            <span>•</span>
                            <span>{movie.genres.join(', ')}</span>
                        </div>

                        <p style={{ fontSize: '0.875rem', color: '#CBD5E1', lineHeight: 1.4, marginBottom: 12 }}>
                            {movie.synopsis}
                        </p>
