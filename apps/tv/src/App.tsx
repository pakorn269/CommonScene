...
export const App: React.FC = () => {
    ...
    const handleRunConsensus = async () => {
        ...
        try {
            ...
            setErrorMessage(
                err instanceof Error ? err.message : 'Failed to calculate consensus'
            );
            setStep('error');
        }
    };
    ...
    const handleRevealWinner = async () => {
        ...
        try {
            ...
            setErrorMessage(
                err instanceof Error ? err.message : 'Failed to finalize winner'
            );
            setStep('error');
        }
    };
    ...
    return (
        <View style={styles.container}>
            ...
            {step === 'demo' && (
                <DemoModeScreen onExit={() => setStep('welcome')} />
            )}
