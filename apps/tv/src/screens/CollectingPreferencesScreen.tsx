...
export const CollectingPreferencesScreen: React.FC<CollectingPreferencesScreenProps> = ({
  roomCode: _roomCode,
  participants,
  onRunConsensus,
  onBack,
  ...
  const allReady = participants.length > 0 && submittedCount === participants.length;

  return (
    <View style={styles.container}>
      {/* Top Bar */}
      <View style={styles.topBar}>
        <Text style={styles.headerSubtitle}>STEP 2 OF 4: COLLECT PREFERENCES</Text>
      ...
      <View style={styles.gridContainer}>
        {participants.map((p) => {
          ...
          return (
            <View
              key={p.id}
              style={[styles.participantCard, isReady && styles.participantCardReady]}
            >
              ...
              <View style={styles.participantInfo}>
                ...
                <Text style={[styles.participantStatus, isReady && styles.participantStatusReady]}>
                  {isReady ? '✓ Preferences Ready' : 'Selecting choices...'}
                </Text>
              </View>
            </View>
          );
      ...
      <View style={styles.bottomBar}>
        <FocusableButton
          ...
          initialFocus={true}
          style={[styles.actionButton, allReady ? styles.actionButtonReady : undefined]}
        />
        <FocusableButton
          label="Back to Lobby"
          onPress={onBack}
