...
export const WinnerScreen: React.FC<WinnerScreenProps> = ({ winningMovie, onStartNew }) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bannerRow}>
        ...
        <View>
          ...
          <Text style={styles.bannerSub}>Consensus choice chosen by your group</Text>
        </View>
      </View>
      ...
      <View style={styles.featureCard}>
        ...
        <View style={styles.metadataRow}>
          <Text style={styles.metadataYear}>{winningMovie.releaseYear}</Text>
          <Text style={styles.metadataDot}>•</Text>
          <Text style={styles.metadataRuntime}>{winningMovie.runtimeMinutes} min</Text>
          <Text style={styles.metadataDot}>•</Text>
