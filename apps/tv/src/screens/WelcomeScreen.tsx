...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onCreateRoom, onDemoMode }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Find a movie everyone loves. Connect phones, submit preferences, and get fair, explainable
          group recommendations on the big screen.
        </Text>
      </View>
