    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentRow}>
        ...
        <View style={styles.codeCard}>
          ...
          <Text style={styles.instructionText}>Open your phone browser to connect:</Text>
          <View style={styles.urlBox}>
            <Text style={styles.urlText}>commonscene.tv</Text>
          </View>
          <Text style={styles.subInstructionText}>No account or download required.</Text>
        </View>

        {/* Right: Joined Participants List */}
        <View style={styles.participantsCard}>
          <Text style={styles.participantsTitle}>Joined Group Members ({participants.length})</Text>
