  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topBar}>
        <Text style={styles.headerSubtitle}>STEP 4 OF 4: GROUP VOTE</Text>
        <Text style={styles.headerTitle}>Voting in Progress ({votes.length} Votes Cast)</Text>
      </View>
      ...
      <View style={styles.cardsRow}>
        {recommendations.slice(0, 3).map((rec, index) => {
          ...
          return (
            <View key={movie.id} style={[styles.card, count > 0 && styles.cardWithVotes]}>
